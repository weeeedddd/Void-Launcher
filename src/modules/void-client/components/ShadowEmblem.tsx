...
export function ShadowEmblem({ className = "", size = 32 }: IShadowEmblemProps) {
  return (
    ...
    >
      <path d="M32 3 55 14 51 43 32 60 13 43 9 14 32 3Z" fill="url(#client-emblem-fill)" stroke="currentColor" strokeWidth="2" />
      ...
      <defs>
        <linearGradient id="client-emblem-fill" x1="12" y1="8" x2="54" y2="55" gradientUnits="userSpaceOnUse">
