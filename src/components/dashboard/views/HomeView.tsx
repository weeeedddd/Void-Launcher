...
/** VIEW 2 · Home — the widgets grid + top bar. */
  ...
  return (
    <div className="h-full overflow-y-auto">
      <div className="mx-auto max-w-6xl px-8 py-7">
        ...
        <div className="mb-7 flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <h1 className="font-serif text-3xl font-black">
              Lord <span className="bg-gradient-to-b from-white to-[#C77DFF] bg-clip-text text-transparent">Shadow</span>
            </h1>
          </div>
        ...
        <p className="mt-6 text-center text-[11px] text-[#5f5878]">Browser-only preview · live data is simulated</p>
      </div>
    </div>
  );
}
